			...
			function Slider(element, config) {
				...
				this.dragger.on('mousedown', function (e) {
					...
					$(_this.line).on('mousemove', function (e) {
						...
						_this.rightEdge = _this.line.width() - 4;
	
						console.log('rightEdgggge');
						console.log(_this.rightEdge);
	
						if (newLeft > _this.rightEdge) {
							newLeft = _this.rightEdge;
							_this.line.off('mousemove');
...
//# sourceMappingURL=0.b3b3dc022d7dc400083d.hot-update.js.map