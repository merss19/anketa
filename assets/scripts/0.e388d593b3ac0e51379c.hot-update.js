	...
	var Slider = function ($) {
	  ...
	  */
		...
		var Slider = function () {
			function Slider(element) {
				...
				this.dragger.on('mousedown', function (e) {
					...
					$(document).on('mousemove', function (e) {
						...
						console.log(e.pageX);
						var newLeft = e.pageX - shiftX - sliderCoords.left - draggerLeft;
						console.log('newLeft');
						console.log(newLeft);
	     ...
	     left rightEdge = this.line.width() - thumbElem.offsetWidth;
...
//# sourceMappingURL=0.e388d593b3ac0e51379c.hot-update.js.map